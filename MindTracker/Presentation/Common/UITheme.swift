...
enum UITheme {
    ...
    enum Font {
        static let authSceneTitle = customFont(name: "Gwen-Trial", size: 48)
        static let authSceneAppleButton = customFont(name: "VelaSans-GX", size: 16)

        static let journalSceneTitle = customFont(name: "Gwen-Trial", size: 36)
        static let journalSceneAddNoteButton = customFont(name: "VelaSans-GX", size: 16)
